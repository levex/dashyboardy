defmodule Dashboard.Widgets do
  ...
  @default_layout %{
    "widgets" => [
      ...
      %{"id" => "weather", "x" => 3, "y" => 0, "w" => 3, "h" => 4, "collapsed" => false},
      %{"id" => "github", "x" => 6, "y" => 0, "w" => 6, "h" => 6, "collapsed" => false},
      %{"id" => "redmine", "x" => 0, "y" => 2, "w" => 3, "h" => 6, "collapsed" => false},
      %{"id" => "rss", "x" => 3, "y" => 4, "w" => 3, "h" => 6, "collapsed" => false},
      %{"id" => "timeline", "x" => 0, "y" => 8, "w" => 12, "h" => 6, "collapsed" => false}
    ],
    "columns" => 12
  }
